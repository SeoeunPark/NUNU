...
public class Stretching3 extends Fragment {
    private TextToSpeech tts;
    Stretching4 next = new Stretching4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_stretching3, container, false);
        initViews(rootView);
        ...
        back_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                pause.setVisibility(View.GONE);
                timerStatus = TimerStatus.STOPPED;
                Fragment newFragment = new Stretching2();
    ...
    private void initViews(View view) {
        ...
        next_btn = (ImageView) view.findViewById(R.id.next3_btn);
        back_btn = (ImageView) view.findViewById(R.id.back2_btn);
    }
